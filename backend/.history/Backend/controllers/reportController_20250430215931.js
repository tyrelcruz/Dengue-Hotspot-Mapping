...
const list_of_barangays = barangays.features.map(
  (feature) => feature.properties.name.toLowerCase().trim()
);

const isBarangayValid = (barangay) => {
  console.log("Input barangay:", barangay);
  console.log("List of barangays:", list_of_barangays);
